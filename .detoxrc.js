...
module.exports = {
  ...
  apps: {
    ...
    'ios.release': {
      type: 'ios.app',
      binaryPath: 'ios/build/Build/Products/Release-iphonesimulator/HexSplash.app',
      build: 'xcodebuild -workspace ios/HexSplash.xcworkspace -scheme HexSplash -configuration Release -sdk iphonesimulator -derivedDataPath ios/build'
    },
    'android.debug': {
      type: 'android.apk',
